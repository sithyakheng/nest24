  ...
  const ranks = [
    {
      ...
      benefits: [
        'Blue Starter badge on all products',
        'Products appear above unranked sellers',
        'Trusted seller indicator',
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 24px', position: 'relative', zIndex: 10 }}>
        ...
        {pendingRequest && (
          <div style={{
            ...
            <p style={{ color: '#E8C97E', fontWeight: '600', margin: 0 }}>
              You have a pending {pendingRequest.rank} rank request. 
        ...
        <div style={{
          ...
          {ranks.map(rank => (
            <div key={rank.id} style={{
              ...
              boxShadow: selectedRank === rank.id ? `0 0 40px ${rank.glow}` : 'none'
            }}
            ...
            >
              {rank.popular && (
                <span style={{
                  ...
                  color: 'black', fontSize: '11px', fontWeight: '800',
              ...
              <h3 style={{ color: rank.color, fontSize: '24px', fontWeight: '900', margin: '0 0 16px 0' }}>
                {rank.name}
              </h3>
        ...
        {selectedRank && !pendingRequest && (
          <div style={{
              ...
              {['Scan QR & Pay', 'Wait up to 24hrs', 'Rank activated!'].map((step, i) => (
                <div key={i} style={{ textAlign: 'center' }}>
                  <div style={{
                    ...
                    color: '#4DB8CC', fontWeight: '900', fontSize: '18px',
            ...
            <div style={{
              ...
              <img
                src={`https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=NestKH-${selectedRank}-${user?.id}`}
                alt="Payment QR Code"
            ...
            {submitted ? (
              <div style={{
                ...
                ✅ Request submitted! We'll review within 24 hours.
              </div>
            ) : (
              <button
